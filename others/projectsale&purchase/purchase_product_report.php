      ...
      <table width="595" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="45"><strong>Product: </strong></td>
       ...
       <td >
        ...
        <tr>
          <td><table width="125%"  border="0" cellspacing="0" cellpadding="0">
			  ...
			  <?php 
			  $result = $db->query("SELECT * FROM stock_entries where  type='entry' AND stock_name='$product' ");
        ...
        <tr>
          ...
          <td align="center"><table width="300" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="150">&nbsp;<?php echo  $age = $db->queryUniqueValue("SELECT sum(subtotal) FROM stock_entries where count1=1 AND type='entry' AND stock_name='$product' ");?></td>
            </tr>
            <tr>
              <td><strong>Paid Amount</strong></td>
              <td>&nbsp;<?php echo  $age = $db->queryUniqueValue("SELECT sum(payment) FROM stock_entries where count1=1 AND type='entry' AND stock_name='$product' ");?></td>
            </tr>
            <tr>
              <td width="150"><strong>Pending Payment </strong></td>
              <td width="150">&nbsp;<?php echo  $age = $db->queryUniqueValue("SELECT sum(balance) FROM stock_entries where count1=1 AND type='entry' AND stock_name='$product' ");?></td>
            </tr>
          </table></td>
        </tr>
