      ...
      <div id="in-wrapper">
        ...
        <div id="body-container">
          <div id="container">
           ...
           <form action="../admin/process_customer.php" method="post" name="form1" id="form1" >
             <table width="89%" align="center" cellpadding="5" cellspacing="0">
               ...
               <tr>
                 ...
                 <input type="text" name="fname" id="fname" title="Enter your Last Name" placeholder="Firstname" required/></span>
               ...
               <tr>
                 ...
                 <td><span id="sprytextarea2">
                   <textarea name="nokaddress" cols="50" rows="3" id="nokaddress2" title="Enter your Next of kin Address" placeholder="Address Of Next Of Kin"></textarea>
                  </span></td>
               </tr>
               <tr>
