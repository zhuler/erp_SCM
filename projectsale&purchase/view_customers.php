	...
	if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
	...
	$sql= "SELECT * FROM  customer_details WHERE customer_name  LIKE '%".$_POST['searchtxt']."%' OR customer_address LIKE '%".$_POST['searchtxt']."%' OR customer_contact1 LIKE '%".$_POST['searchtxt']."%' OR customer_contact1 LIKE '%".$_POST['searchtxt']."%'  LIMIT $start, $limit";
