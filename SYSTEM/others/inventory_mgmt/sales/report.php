...
<?php
$dated = date("d/m/Y");
$getrec = mysql_query ("SELECT * FROM sales_rec WHERE date = '$dated' ORDER BY id DESC") or die(mysql_error());?>
...
<?php 
	...
	<tr class=''>
    <td><?php echo $sn;?></td>
    <td><a href="tmp_eradicate.php?id=<?php echo $receipt;?>&type=report" style="color:#390;" title="Click here to view sales product breakdown"><?php
