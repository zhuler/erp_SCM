...
$start = $_GET['p'];
$getrec = mysql_query ("SELECT * FROM sales_rec WHERE `date` = '$start' ORDER BY id DESC") or die(mysql_error());?>
<table width="100%" align="center" cellpadding="5" cellspacing="0" class="example table-autosort:0 table-stripeclass:alternate" id="TABLE_2">
  <thead>
    ...
    <tr>
      ...
      <th width="6%" class='table-sortable:default table-sortable' title='Click to sort'style="color:#FFF">AMOUNT
      <th width="6%" class='table-sortable:default table-sortable' title='Click to sort' style="color:#FFF">DISCOUNT
