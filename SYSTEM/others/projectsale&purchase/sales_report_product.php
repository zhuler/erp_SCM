      ...
      <table width="595" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
			  ...
			  <?php 
			  $result = $db->query("SELECT * FROM stock_sales where count1=1 AND stock_name='$product' ");
  ...
  <tr>
          ...
          <td align="center"><table width="300" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="150">&nbsp;<?php echo  $age = $db->queryUniqueValue("SELECT sum(subtotal) FROM stock_sales where count1=1  AND stock_name='$product'  ");?></td>
            </tr>
            <tr>
              <td><strong>Received Amount</strong></td>
              <td>&nbsp;<?php echo  $age = $db->queryUniqueValue("SELECT sum(payment) FROM stock_sales where count1=1 AND stock_name='$product'  ");?></td>
            </tr>
            <tr>
              <td width="150"><strong>Total OutStanding </strong></td>
              <td width="150">&nbsp;<?php echo  $age = $db->queryUniqueValue("SELECT sum(balance) FROM stock_sales where count1=1 AND stock_name='$product' ");?></td>
            </tr>
          </table></td>
        </tr>
</table>
