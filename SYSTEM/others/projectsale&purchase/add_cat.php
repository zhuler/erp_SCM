	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				...
				<li><a href="page-other.php" class="active-tab stock-tab">Stocks / Products</a></li>
				...
				<form name="form1" method="post" id="form1" action="">
                  ...
                  <table class="form"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td><input name="name" type="text" id="name" maxlength="200"  class="round default-width-input" value="<?php echo $name; ?>" /></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                    ...
                    <tr>
                      <td>Address</td>
                      <td><textarea name="address" cols="15" class="round full-width-textarea"><?php echo $address; ?></textarea></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
